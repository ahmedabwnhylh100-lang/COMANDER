...
"""
╔══════════════════════════════════════════════════════════════════════════╗
║  🔥 𝑪𝑶𝑴𝑨𝑵𝑫𝑬𝑹 VPS BOT - VPS Control Panel (Lunes Host Style)                  ║
║  # COMANDER_VPS_BOT                                                          ║
╠══════════════════════════════════════════════════════════════════════════╣
...
def load_master_config():
    default_config = {
        'master_username': 'COMANDER_ADMIN',
        'master_password_hash': hashlib.sha256('COMANDER_VPS_2025'.encode()).hexdigest(),
        'port': 3178,
        'main_file': 'main.py'
    }
...
MASTER_USERNAME      = MASTER_CONFIG.get('master_username', 'COMANDER_ADMIN')
...
# تهيئة ملفات المالك
init_json_file(OWNER_CONFIG_FILE, {'telegram_token': '', 'telegram_owner_id': '', 'bot_linked': False, 'panel_name': 'COMANDER VPS BOT', 'welcome_msg': 'مرحباً بك في لوحة التحكم'})
...
def load_owner_config():
    default = {'telegram_token': '', 'telegram_owner_id': '', 'bot_linked': False, 'panel_name': 'COMANDER VPS BOT', 'welcome_msg': 'مرحباً بك في لوحة التحكم'}
...
<title>صيانة - COMANDER VPS BOT</title>
<style>
...
<div class="maint-card">
  ...
  <div class="maint-footer">جميع الحقوق محفوظة &copy; COMANDER VPS BOT</div>
</div>
</body>
</html>
'''
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>COMANDER VPS BOT — Access Panel</title>
<style>
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>COMANDER VPS BOT — Server Panel</title>
<style>
*{margin:0;padding:0;box-sizing:border-box;font-family:'Inter','Segoe UI',sans-serif}
...
<!-- ===== TOPBAR ===== -->
<div class="topbar">
  <div class="brand">COMANDER VPS BOT<span class="lc">LLC</span></div>
  <div class="icons">
  ...
  <div class="section-card">
    ...
    <div class="section-body">
      <div class="field-block">
        ...
        <input id="panel-name-inp" placeholder="COMANDER VPS BOT">
      </div>
      <div class="field-block">
...
def run_extra_port(port, note=""):
    ...
    try:
        ...
        @sub.route('/')
        def _h():
            return f"<h1 style='font-family:sans-serif;color:#29c7d3;background:#1f2933;padding:40px;text-align:center'>COMANDER VPS BOT — Port {port}</h1><p style='color:#9aa9b3;text-align:center'>{html.escape(note)}</p><p style='text-align:center'><a style='color:#2f6fed' href='/'>Open user app here</a></p>"
...
""".format(mu=MASTER_USERNAME))
    ...
    print(f"   Login: {MASTER_USERNAME} / COMANDER_VPS_2025 (default)")
